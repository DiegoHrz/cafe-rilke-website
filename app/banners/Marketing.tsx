  ...
  return (
    <div className="mx-auto w-[80%] py-10 sm:my-10 ">
      ...
      <Ribbon
        ...
        y la gastronomía"'
      />
      {/* <p className=" px-4 text-sm mt-2 md:text-base md:pt-2 text-gray-600 text-center absolute top-1/2 left-1/2">
        &apos;La inauguración del café propició el encuentro del arte, la música
        y la gastronomía&apos;
      </p> */}
        ...
        >
           <div className="flex  flex-col   mx-auto justify-center py-3 md:py-5 px-6   lg:gap-0  bg-none rounded-full max-h-[18rem] aspect-square   max-w-[18rem] relative">
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 h-[96%] w-[96%] sm:h-[110%] sm:w-[110%] -z-10 overflow-visible">
              <img
                src="/assets/frames/cert1.png"
                className="w-full h-full object-cover animation-rotation"
                alt="Rotating certificate"
              />
            </div>
