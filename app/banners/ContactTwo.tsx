...
const  ContactTwo=()=> {
  ...
  return (
    ...
    <div
      className="w-full bg-gradient-to-br from-[#F5F5F5] via-[#F5F5F5] to-gray-300  px-8 text-center lg:my-[0px] lg:px-[12.5rem] pt-20 pb-60  lg:pb-32 border-2 border-green-500"
      id="contacto"
    >
      ...
      <div className="w-full  lg:p-8 mt-2 rounded-2xl flex justify-center border-2 border-blue-500">
        <form
          action=""
          id="form"
