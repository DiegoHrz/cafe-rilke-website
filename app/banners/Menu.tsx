...
export function Menu() {
  return (
    <div
      className="pt-[8.6rem] pb-[2rem] lg:pt-[100px] lg:pb-[50px]  bg-[linear-gradient(180deg,_#fff_1%,_#fefefe_3.4%,_#e7dbdb_20%,_#d4c1c1_40%,_#d2c8c8_60%,_#f7f7f7_95%,_#fff_100%)] "
      id="carta"
    >
      ...
      <p className=" text-center font-medium  text-lg lg:text-xl text-[#7b6c6c] pb-3  px-10 sm:px-24 lg:max-w-[72rem] mx-auto">
        ...
        <p className="mt-4">
          Puedes ingresar a la Carta en PDF{" "}
          <a
            href="assets/menu/carta.pdf"
            target="_blank"
            rel="noopener noreferrer"
            className="lg:hover:underline underline text-blue-800"
          >
            aquí
          </a>
        </p>
